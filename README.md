...
| Submit a batch job that generates the pmtiles for every parquet dataset of the uuid (returns 202 with the Batch job id) | (PUT) /api/v1/das/pmtiles/{uuid}                                                        | none                                                                                                                                                                                      | ALL         |
| List all registered data-tile products                                                                                  | (GET) /api/v1/das/tiler/data_tiles/products                                             | none                                                                                                                                                                                      | ALL         |
| Get data-tile manifest (available dates + date range per product)                                                       | (GET) /api/v1/das/tiler/data_tiles/manifest                                             | from, to (both optional)                                                                                                                                                                  | ALL         |
| Get raw value-encoded data tile                                                                                         | (GET) /api/v1/das/tiler/data_tiles/{product_id}/{date}/{z}/{x}/{y}.png                  | none                                                                                                                                                                                      | ALL         |
| Get data tile config (bounds, value ranges, LOD grid)                                                                   | (GET) /api/v1/das/tiler/data_tiles/{product_id}/{date}/manifest.json                    | none                                                                                                                                                                                      | ALL         |
| Get point value lookup (data tile)                                                                                      | (GET) /api/v1/das/tiler/data_tiles/{product_id}/{date}/point                            | lat, lon                                                                                                                                                                                  | ALL         |
| List all registered visual-tile products                                                                                | (GET) /api/v1/das/tiler/visual_tiles/products                                           | none                                                                                                                                                                                      | ALL         |
| Get visual-tile manifest (available dates + date range per product)                                                     | (GET) /api/v1/das/tiler/visual_tiles/manifest                                           | from, to (both optional)                                                                                                                                                                  | ALL         |
| Get point value lookup (visual tile)                                                                                    | (GET) /api/v1/das/tiler/visual_tiles/{product_id}/{date}/point                          | lat, lon                                                                                                                                                                                  | ALL         |
| Get colourised Web Mercator (XYZ) tile                                                                                  | (GET) /api/v1/das/tiler/visual_tiles/{product_id}/{date}/{z}/{x}/{y}.{ext}              | ext=png or webp, colormap, rescale=min,max (colormap and rescale optional)                                                                                                                | ALL         |
| Get colourised image for an arbitrary bbox                                                                              | (GET) /api/v1/das/tiler/visual_tiles/{product_id}/{date}/bbox.{ext}                     | bbox=minx,miny,maxx,maxy, crs (optional, default EPSG:4326), colormap, rescale (optional)                                                                                                 | ALL         |
| Get an animated bbox over a date range                                                                                  | (GET) /api/v1/das/tiler/visual_tiles/{product_id}/{from_date}/{to_date}/animation.{ext} | ext=gif, apng or webp, bbox, width, height (all optional, 30-frame cap)                                                                                                                   | ALL         |
| List supported colormaps                                                                                                | (GET) /api/v1/das/tiler/visual_tiles/colormaps                                          | none                                                                                                                                                                                      | ALL         |
| Get color legend PNG for a colormap                                                                                     | (GET) /api/v1/das/tiler/visual_tiles/colormaps/{name}/legend                            | rescale=min,max, width, height, orientation (all optional)                                                                                                                                | ALL         |

`{product}` in the `feature-collection` endpoints above must be one of: `mooring`, `wave-buoy`.
