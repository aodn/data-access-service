...
<head>
    ...
    <style type="text/css">
        ...
        .l {{ width:528px !important; max-width: 528px; }}
        .o {{ width:100% !important; max-width: 100%; }}
        .m {{ width:8px !important; max-width: 8px; }}
        .f {{ width:117px !important; max-width: 117px; }}
        .d {{ width:12px !important; max-width: 12px; }}
        .a {{ width:112px !important; max-width: 112px; }}
        .d3 {{ width:142px !important; max-width: 142px; }}
        .g6 {{ width:145px !important; max-width: 145px; }}
        }}
    </style>
    <style media="screen and (min-width:599px)">
        .moz-text-html .p {{ width:568px !important; max-width: 568px; }}
        .moz-text-html .l {{ width:528px !important; max-width: 528px; }}
        .moz-text-html .o {{ width:100% !important; max-width: 100%; }}
        .moz-text-html .m {{ width:8px !important; max-width: 8px; }}
        .moz-text-html .f {{ width:117px !important; max-width: 117px; }}
        .moz-text-html .d {{ width:12px !important; max-width: 12px; }}
        .moz-text-html .a {{ width:112px !important; max-width: 112px; }}
        .moz-text-html .d3 {{ width:142px !important; max-width: 142px; }}
        .moz-text-html .g6 {{ width:145px !important; max-width: 145px; }}
    </style>
    <style type="text/css">
    ...
    <style type="text/css">
        ...
        .u .mq img {{ max-width: none!important; width: 100%!important; height: auto!important; }}
        ...
        div.g.hb > table > tbody > tr > td {{ padding-bottom:12px!important }}
        }}.tr-0 {{ }}
    </style>
...
<div style="background-color:#7e7e7e;" lang="en" dir="auto">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:600px;" width="600" bgcolor="#fffffe">
        <tr>
            <td style="line-height:0;font-size:0;mso-line-height-rule:exactly;">
    <![endif]-->
    <div class="w e y" style="background:#fffffe;background-color:#fffffe;margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#fffffe;background-color:#fffffe;width:100%;">
            <tbody>
            <tr>
                            ...
                            <td width="600px">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:568px;" width="568">
                                    <tr>
                                        <td style="line-height:0;font-size:0;mso-line-height-rule:exactly;">
                    <![endif]-->
                    <div class="r e y" style="background:#fffffe;background-color:#fffffe;margin:0px auto;border-radius:16px 16px 0px 0px;max-width:568px;">
                                            ...
                                            <tr>
                                                <td align="left" style="font-size:0;padding-bottom:24px;word-break:break-word;">
                                                    <div style="font-family:'Open Sans', 'Arial', sans-serif;font-size:16px;font-weight:400;line-height:150%;text-align:left;color:#2571e9;">
                                                        ...
                                                        <p style="Margin:0;mso-line-height-alt:24px;font-size:16px;line-height:150%;"><span style="color:#090c02;">Your AODN data download request has been completed. Please click on the following link to access your data request.<br class="s"></span><span style="text-decoration:underline;">{object_url_str}</span></p></div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                            ...
                                                            <td align="left" class="u" style="padding:0;height:auto;word-wrap:break-word;vertical-align:middle;" width="528">
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td align="left" width="100%">
                                                                            <div style="font-family: 'Open Sans', 'Arial', sans-serif; font-size: 16px; font-weight: 400; line-height: 150%; text-align: left; color: #2571e9">
                                                                                <p style="Margin:0;mso-line-height-alt:24px;font-size:16px;line-height:150%;"><span style="color:#090c02;">Metadata link: </span><span style="text-decoration:underline;"><a href={full_metadata_link} style="color:#2571e9;text-decoration:underline;">{full_metadata_link}</a></span></p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
    ...
    <div class="r e y" style="background:#fffffe;background-color:#fffffe;margin:0px auto;max-width:600px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#fffffe;background-color:#fffffe;width:100%;">
            <tbody>
            <tr>
                <td style="border-bottom:none;border-left:none;border-right:none;border-top:1px solid #bfbfbf;direction:ltr;font-size:0;padding:24px 16px 8px 16px;text-align:center;">
                    <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="vertical-align:middle;width:568px;">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#fffffe;background-color:#fffffe;width:100%;">
            ...
            <tr>
                <td style="border:none;direction:ltr;font-size:0;padding:4px 16px 4px 16px;text-align:center;">
                    ...
                    <![endif]-->
                    <div class="m h" style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tbody>
                            <tr>
                                <td style="vertical-align:top;padding:0;">
                    ...
                    <td style="vertical-align:middle;width:117px;">
                    <![endif]-->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border:none;vertical-align:middle;" width="100%">
                            ...
                            <tr>
                                <td align="left" class="b x" style="font-size:0;padding:0;word-break:break-word;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:117px;line-height:100%;">
                                        <tbody>
                                        <tr>
                                            <td align="center" bgcolor="#595959" class="c" role="presentation" style="background:#595959;border:none;border-radius:8px 8px 8px 8px;cursor:auto;mso-padding-alt:8px 0px 8px 0px;vertical-align:middle;" valign="middle">
                                                <!--[if mso]>
                                                <v:roundrect style="width:115px;height:38px;v-text-anchor:middle;" arcsize="42%" fill="t" stroke="f" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word">
                                                    <w:anchorlock/>
                                                    <v:fill type="solid" color="#595959" />
                                                    <v:textbox inset="0,0,0,0">
                                                        <center>
                                                <![endif]-->
                                                <a href="mailto:info@aodn.org.au" class="c" style="display:inline-block;width:117px;background-color:#595959;color:#ffffff;font-family:'Open Sans', 'Arial', sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:8px 0px 8px 0px;mso-padding-alt:0;border-radius:8px 8px 8px 8px;" target="_blank">
                                                    <span style="font-size:14px;font-family:'Open Sans', 'Arial', sans-serif;font-weight:500;color:#ffffff;line-height:157%;mso-line-height-alt:22px;">Contact Us</span>
                                                </a>
                                                <!--[if mso]>
                                                </center>
                                                </v:textbox>
                    ...
                    <![endif]-->
                    <div class="d h g hb" style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            <tbody>
                            <tr>
                                <td style="vertical-align:top;padding:0;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:112px;line-height:100%;">
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="transparent" role="presentation" style="background:transparent;border:none;border-radius:8px 8px 8px 8px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;vertical-align:middle;" valign="middle">
                                                <a href="https://imos.org.au/terms-of-use" style="display:inline-block;width:112px;color:#ffffff;font-family:'Open Sans', 'Arial', sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:8px 8px 8px 8px;" target="_blank">
                    ...
                    <![endif]-->
                    <div class="d3 h" style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border:none;vertical-align:middle;" width="100%">
                            <tbody>
                            <tr>
                                <td align="left" class="b x" style="font-size:0;padding:0;word-break:break-word;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:142px;line-height:100%;">
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="transparent" role="presentation" style="background:transparent;border:none;border-radius:8px 8px 8px 8px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;vertical-align:middle;" valign="middle">
                                                <a href="https://imos.org.au/conditions-of-use" style="display:inline-block;width:142px;color:#ffffff;font-family:'Open Sans', 'Arial', sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:8px 8px 8px 8px;" target="_blank">
                            ...
                            <tr>
                                <td align="left" class="b x" style="font-size:0;padding:0;word-break:break-word;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:145px;line-height:100%;">
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="transparent" role="presentation" style="background:transparent;border:none;border-radius:8px 8px 8px 8px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;vertical-align:middle;" valign="middle">
                                                <a href="https://imos.org.au/resources/acknowledging-us" style="display:inline-block;width:145px;color:#ffffff;font-family:'Open Sans', 'Arial', sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:8px 8px 8px 8px;" target="_blank">
                    ...
                    <div class="o h wa" style="font-size:0;line-height:0;text-align:left;display:inline-block;width:100%;direction:ltr;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                <td style="vertical-align:middle;width:568px;">
                        <![endif]-->
                        <div class="o h" style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border:none;vertical-align:middle;" width="100%">
                                <tbody>
                                <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:24px;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                <a href="https://www.instagram.com/imos_australia/" target="_blank">
                                            ...
                                            <tr>
                                                <td style="padding:0 16px 0 0;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:24px;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                <a href="https://www.facebook.com/IntegratedMarineObservingSystem" target="_blank">
                                            ...
                                            <tr>
                                                <td style="padding:0 16px 0 0;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:24px;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                <a href="https://bsky.app/profile/imos-aus.bsky.social" target="_blank">
                                                                    <img alt="Bluesky" height="24" src="data:image/png;base64,{BLUESKY_IMG}" style="display:block;" width="24">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                            ...
                                            <tr>
                                                <td style="padding:0;padding-right:0;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:24px;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                <a href="https://www.linkedin.com/company/imos_aus/posts/?feedView=all" target="_blank">
