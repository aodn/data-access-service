def generate_download_button_html(object_urls):
    ...
    <div class="r e y" style="background:#fffffe;background-color:#fffffe;margin:0px auto;max-width:568px;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#fffffe;background-color:#fffffe;width:100%;">
            <tbody>
            <tr>
                <td align="center" class="b" style="border:none;direction:ltr;font-size:0;padding:0px 20px 8px 20px;text-align:center;word-break:break-word;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:240px;line-height:100%;margin:0 auto;">
                        <tbody>
                        <tr>
