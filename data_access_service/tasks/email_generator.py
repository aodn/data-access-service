...
def generate_completed_email_content(
    uuid, conditions: List[Tuple[str, str]], object_url
):
    conditionString = ""
    for condition in conditions:
        conditionString += condition[0] + ": " + condition[1] + ", "
    ...
    return (
        "The result is ready. \nThe id of the dataset is: "
        + uuid
        + "The condition(s): "
        + conditionString
        + ". \nYou can download it. The download link is: "
        + object_url
    )
