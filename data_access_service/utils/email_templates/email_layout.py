"""Shared layout for all AODN emails: head styles, logo banner and footer."""
...
<head>
    ...
    <![endif]-->
    <!--[if !mso]><!-->
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;500&display=swap" rel="stylesheet" type="text/css">
    <!--<![endif]-->
    <style type="text/css">
...
# <body> opening and the IMOS/AODN logo banner at the top of the email.
EMAIL_HEADER = f"""<body lang="en" link="#DD0000" vlink="#DD0000" class="emailify" style="mso-line-height-rule: exactly; mso-hyphenate: none; word-spacing: normal; background-color: #7e7e7e;">
...
# The footer: about text, link buttons, social icons and the closing </body></html>.
EMAIL_FOOTER = f"""                    <!--[if mso | IE]>
                    </td>
                    </tr>
                    </table>
                    </td>
