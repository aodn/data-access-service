...
class TestSyncAWSBatchConfigs(unittest.TestCase):
    ...
    def test_sync_aws_batch_job_definition_no_changes(self, mock_log, mock_config, mock_aws_client):
        ...
        mock_config_instance.get_job_definition_name.return_value = "test-job-definition"
        with patch("data_access_service.batch.tasks.sync_aws_batch_configs.get_local_json") as mock_get_local_json:
            mock_get_local_json.return_value = {"key": "value"}

            sync_aws_batch_job_definition(config=mock_config_instance, aws=mock_aws, log=mock_log_instance)
    ...
    @patch("data_access_service.batch.tasks.sync_aws_batch_configs.Config")
    @patch("data_access_service.batch.tasks.sync_aws_batch_configs.init_log")
    def test_sync_aws_batch_job_queue_needs_update(self, mock_log, mock_config, mock_aws_client):
        mock_aws = mock_aws_client.return_value
        mock_config_instance = mock_config.return_value
        mock_log_instance = mock_log.return_value
        ...
        with patch("data_access_service.batch.tasks.sync_aws_batch_configs.get_local_json") as mock_get_local_json:
            ...
            with patch("data_access_service.batch.tasks.sync_aws_batch_configs.does_job_queue_need_update") as mock_needs_update:
                mock_needs_update.return_value = True

                sync_aws_batch_job_queue(config=mock_config_instance, aws=mock_aws, log=mock_log_instance)
    ...
    @patch("data_access_service.batch.tasks.sync_aws_batch_configs.Config")
    @patch("data_access_service.batch.tasks.sync_aws_batch_configs.init_log")
    def test_sync_aws_batch_compute_environment_no_cloud_environment(self, mock_log, mock_config, mock_aws_client):
        mock_aws = mock_aws_client.return_value
        mock_config_instance = mock_config.return_value
        mock_log_instance = mock_log.return_value

        mock_aws.get_batch_compute_environment_config.return_value = None
        mock_config_instance.get_compute_environment_name.return_value = "test-compute-environment"

        sync_aws_batch_compute_environment(config=mock_config_instance, aws=mock_aws, log=mock_log_instance)
